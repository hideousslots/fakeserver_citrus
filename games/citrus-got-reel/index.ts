...
export const index: IGame<IData> = {
    ...
    stats: {
        ...
        bonusGameTriggeringFrequency: new HitFrequency(
            wagers => wagers.some(wager => wager.data.bonusGameSpins.length > 0)),
        hitFrequency:   new HitFrequency(wagers => wagers.some(wager => wager.win > 0)),
         _0x:            new HitFrequency(wagers => wagers.some(wager => wager.win === 0)),
         _1x:            new HitFrequency(wagers => wagers.some(wager => wager.win > 1)),
         _2x:            new HitFrequency(wagers => wagers.some(wager => wager.win > 2)),
         _3x:            new HitFrequency(wagers => wagers.some(wager => wager.win > 3)),
         _4x:            new HitFrequency(wagers => wagers.some(wager => wager.win > 4)),
