...
export const index: IGame<IData> = {
    ...
    stats: {
        ...
        averageWildFeatures: new Average(
          ...
          _5x: new HitFrequency(wagers => wagers.some(wager => wager.win > 5)),
          _10x: new HitFrequency(wagers => wagers.some(wager => wager.win > 10)),
          _15x: new HitFrequency(wagers => wagers.some(wager => wager.win > 15)),
          _20x: new HitFrequency(wagers => wagers.some(wager => wager.win > 20)),
          _25x: new HitFrequency(wagers => wagers.some(wager => wager.win > 25)),
          _30x: new HitFrequency(wagers => wagers.some(wager => wager.win > 30)),
          _35x: new HitFrequency(wagers => wagers.some(wager => wager.win > 35)),
          _40x: new HitFrequency(wagers => wagers.some(wager => wager.win > 40)),
          _45x: new HitFrequency(wagers => wagers.some(wager => wager.win > 45)),
