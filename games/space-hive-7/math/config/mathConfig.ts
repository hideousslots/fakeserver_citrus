...
const standardConfig = {
    ...
    bonusBuyGameProfilesDistribution: { //RTP
        // values: [InstantHeavy],
        // weights: [3000],
        values: [BonusLow, BonusNewLow, InstantHeavy, ReplaceHeavy, BonusHigh],
        weights: [500, 6125, 1900, 1900, 75],
    },
    ...
    bonusGameReelSetsDistributions: {
        ...
        BonusNewLow: {
            MinWays: {
                values: [6, 7, 8],
                weights: [400000, 350000, 350000],
            },
            LowWays: {
                values: [6, 7, 8],
                weights: [500000, 350000, 350000],
            },
            MedWays: {
                values: [6, 7, 8],
                weights: [600000, 350000, 350000],
            },
            HighWays: {
                values: [6, 7, 8],
                weights: [700000, 250000, 250000],
            },
            MaxWays: {
                values: [6, 7, 8],
                weights: [800000, 250000, 250000],
            },
        },
        BonusMed: {
            MinWays: {
    ...
    baseGameFeaturesDistributions: {
        BaseGameUltraLow: {
            MinWays: {
                ...
                weights: [160,10,10,10,10,10,10,10,10,10,10,10,10,40,1],
            },
            LowWays: {
                values: [
                    {featureType: None},
        ...
        BaseGameLow: {
            MinWays: {
                ...
                weights: [935000, 14000, 5000, 1000, 5500, 3500, 3500, 500, 15000, 15000],
            },
            LowWays: {
                values: [
                    {featureType: None},
                ...
                weights: [900000, 14500, 5000, 500, 4000, 3000, 3000, 2000, 35000, 35000, 4500],
            },
            MedWays:  {
                values: [
                    {featureType: None},
                ...
                weights: [880000, 4500, 1500, 7000, 5000, 5000, 45000, 45000, 6000],
            },
            HighWays: {
                values: [
                    {featureType: None},
    ...
    bonusGameFeaturesDistributions: {
        UltraLow: {
            MinWays: {
                ...
                weights: [2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 20, 1],
            },
            LowWays: {
                values: [
                    {featureType: None},
            ...
            HighWays: {
                ...
                weights: [320, 20, 3, 3, 3, 3, 3, 65, 10],
            },
            MaxWays: {
                values: [
                    {featureType: None},
...
anteConfig.baseGameFeaturesDistributions.BaseGameUltraLow = {
    MinWays: {
        ...
        weights: [160,10,10,10,10,10,10,10,10,10,10,10,10,40, 7],
    },
    LowWays: {
        values: [
            {featureType: None},
...
anteConfig.baseGameFeaturesDistributions.BaseGameLow = {
    ...
    LowWays: {
        ...
        weights: [900000, 14500, 5000, 500, 4000, 3000, 3000, 2000, 75000, 75000, 15000],
    },
    MedWays:  {
        values: [
            {featureType: None},
        ...
        weights: [880000, 4500, 1500, 7000, 5000, 5000, 60000, 60000, 6000],
    },
    HighWays: {
        values: [
            {featureType: None},
