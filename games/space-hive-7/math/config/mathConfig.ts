...
export const standardConfig = {
    ...
    baseGameFeaturesDistributions: {
        ...
        BaseGameLow: {
            MinWays: {
                ...
                weights: [235000, 14000, 5000, 1000, 5500, 3500, 3500, 500, 9500, 9500],
            },
            LowWays: {
                values: [
                    {featureType: None},
                ...
                weights: [200000, 14500, 5000, 500, 4000, 3000, 3000, 2000, 35000, 35000, 50],
            },
            MedWays:  {
                values: [
                    {featureType: None},
                ...
                weights: [400000, 4500, 1500, 7000, 5000, 5000, 45000, 45000, 50],
            },
            HighWays: {
                values: [
                    {featureType: None},
    ...
    bonusGameFeaturesDistributions: {
        ...
        BonusCoinSmall: {
            MinWays: {
                ...
                weights: [
                        240, //none
                        50, 50, 50, 50, 50, 30, 30, 30, 30, 30, //Wins
                        50, 10, 10, 10,  //Wilds
                    ],
            },
            LowWays: {
            ...
            HighWays: {
                ...
                weights: [
                    750000, 
                    3000, 1500, 250, 50,
                    5000, 5000, 5000, 3000, 1500, 3000, 2000, 12500, 12500, 12500,
                    1500, 2000,
                    5000,
                    ],
            },
    ...
    instantPrizeCoinsConfig: {
        ...
        bonusGameProfiles: [
            ...
            { //16
            fixedBetMultipliers: [500, 100, 100, 100],
            randomBetMultiplierDistributionsIndices: [3, 3, 3, 3, 3],
            threshold: 750,
            fallbackDistributionIndex: 0,
            },
            { //17
            fixedBetMultipliers: [250, 250, 50, 100, 50],
            randomBetMultiplierDistributionsIndices: [4, 4, 4],
            threshold: 800,
            fallbackDistributionIndex: 0,
            },
            { //18
            fixedBetMultipliers: [250, 500, 50],
            randomBetMultiplierDistributionsIndices: [3, 3, 3, 3, 3, 3],
            threshold: 830,
            fallbackDistributionIndex: 0,
            },
            { //19
            fixedBetMultipliers: [500, 250, 50],
            randomBetMultiplierDistributionsIndices: [1],
            threshold: 830,
            fallbackDistributionIndex: 0,
            },
            { //20
            fixedBetMultipliers: [500, 10],
            randomBetMultiplierDistributionsIndices: [4, 4, 4, 4, 4],
            threshold: 830,
            fallbackDistributionIndex: 0,
            },
            { //21
            ...
            { //24
                fixedBetMultipliers: [10, 5],
                randomBetMultiplierDistributionsIndices: [0],
                threshold: 7,
                fallbackDistributionIndex: 0,
            },
            { //25
                fixedBetMultipliers: [25, 10],
                randomBetMultiplierDistributionsIndices: [0],
                threshold: 7,
                fallbackDistributionIndex: 0,
            },
