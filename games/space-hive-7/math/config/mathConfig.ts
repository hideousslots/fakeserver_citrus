    ...
    bonusGameFeaturesDistributions: {
        ...
        BonusLow: {
            MinWays: {
                ...
                weights: [830000, 67500, 3000, 2400, 600, 2400, 600, 2550, 450, 2550, 450, 2550, 450, 2550, 450, 2550, 450, 2550, 450, 2550, 450, 22500, 40000, 7500, 2500],
            },
            LowWays: {
                values: [
                    {featureType: None},
        ...
        ReplaceHeavy: {
            MinWays: {
                ...
                weights: [900000, 4000, 600, 250, 100, 50, 6300, 700, 6300, 700, 6300, 700, 6300, 700, 6300, 700, 5950, 1050, 5950, 1050, 5950, 1050, 5950, 1050, 5950, 1050, 3125, 5250, 5750, 3125, 3063, 2250, 1500, 938], 
            },
            LowWays: {
                values: [
                    {featureType: None},
                ...
                weights: [870000, 4100, 500, 250, 150, 4500, 500, 4500, 500, 4500, 500, 4500, 500, 4500, 500, 12900, 1800, 300, 12900, 1800, 300, 12900, 1800, 300, 12900, 1800, 300, 12900, 1800, 300, 3125, 5250, 5750, 3125, 3063, 2250, 1500, 938],
            },
            MedWays: {
                values: [
                    {featureType: None},
                ...
                weights: [875000, 6000, 3000, 1000, 6790, 210, 6790, 210, 5820, 180, 4850, 150, 4850, 150, 14560, 1200, 240, 12740, 1050, 210, 12740, 1050, 210, 11830, 975, 195, 11830, 975, 195, 1875, 3150, 3450, 1875, 1838, 1350, 900, 563],
            },
            HighWays: {
                values: [
                    {featureType: None},
                ...
                weights: [850000, 6500, 2700, 500, 300, 8918, 182, 8918, 182, 7644, 156, 6370, 130, 6370, 130, 18304, 1872, 624, 16016, 1638, 546, 16380, 1456, 364, 15041, 1521, 338, 15210, 1352, 338, 1250, 2100, 2300, 1250, 1225, 900, 600, 375],
            },
        },
        InstantHeavy: {
            MinWays: {
