...
export interface ExpandedInstantPrizeCoin {
    betMultiplier: number,
    win: number,
    position: Position,
}

export interface ExpandedInstantPrizeCoinData {
    coinData: ExpandedInstantPrizeCoin[],
    reelsBefore: SpaceHiveSymbol[][],
...
function appendCoinPosition(integerRng: IntegerRng,
                            ...
                            instantPrizeCoins: ExpandedInstantPrizeCoin[],
                            betMultiplier: number,
                            precisionMoneyMapper: (a: number) => number,
                            bet: number) {
